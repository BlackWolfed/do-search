...
print("site:pastebin.com intext:'{}' OR intext:'{}' OR intext:'{}'".format(i, i, i))
print("site:whycall.me intext:'{}' OR intext:'{}' OR intext:'{}'".format(i, i, i))
print("site:locatefamily.com intext:'{}' OR intext:'{}' OR intext:'{}'".format(i, i, i))
print("site:spytox.com intext:'{}'".format(i))
print("=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-==-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=")
